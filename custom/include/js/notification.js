                    ...
                    for (var singleArray in getarrstr) {
                        ...
                        switch (fieldMap[getarrstr[singleArray][1]]) {
                            ...
                            case "Note":
                                ...
                                break;
                            case "Thread":
                                var thread_url = "index.php?module=" + getarrstr[singleArray][1] + "&action=DetailView&record=" + singleArray;
                                var subTitle = "New " + fieldMap[getarrstr[singleArray][1]] + " Created : " + getarrstr[singleArray][0];
                                var thread_notification = webkitNotifications.createNotification(iconImageUrl, title, subTitle);
                                thread_notification.show();
                                thread_notification.addEventListener('click', function() {
