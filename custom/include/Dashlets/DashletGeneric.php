 ...
 * @api
 */
class CustomDashletGeneric extends DashletGeneric {

    public function loadCustomMetadata() {
        if ($this->seedBean->ComplaintDashlet == true) {
            $customMetadate = 'custom/modules/' . $this->seedBean->module_dir . '/metadata/complaintdashletviewdefs.php';
        } else {
