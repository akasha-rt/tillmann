...
class EmailsFromContactByMonth_sfn15 extends DashletGenericBarChart {

    protected function getDataset() {
        global $db;
        $returnArrayEmailsPerContactByMonth = array();

        $dashletSql = $this->getEmailsFromContactByMonth_sfn15();
    ...
    protected function getEmailsFromContactByMonth_sfn15() {
        return "SELECT 
                ...
                FROM
                    ...
                    contacts ON contacts.id = email_addr_bean_rel.bean_id
                        ...
                        AND contacts.lead_source = 'sfn15'
                WHERE
