...
class NewProductComplaintDashlet extends CustomDashletGeneric {
    ...
    function process($lvsParams = array()) {
        ...
        $lvsParams = array(
            'custom_select' => "SELECT product_complaint_tbl.complaint_product AS complaint_product,
                                       product_complaint_tbl.complaint AS complaint ",
            'custom_from' => " FROM product_complaint_tbl ",
