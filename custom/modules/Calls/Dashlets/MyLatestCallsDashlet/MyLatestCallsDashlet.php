...
class MyLatestCallsDashlet extends DashletGeneric {

    function MyLatestCallsDashlet($id, $def = null) {
        global $current_user, $app_strings;
        require('custom/modules/Calls/Dashlets/MyLatestCallsDashlet/MyLatestCallsDashlet.data.php');

        parent::DashletGeneric($id, $def);

        if (empty($def['title']))
            $this->title = translate('LBL_LIST_MY_LATEST_CALLS', 'Calls');
        $this->searchFields = $dashletData['MyLatestCallsDashlet']['searchFields'];
        ...
        $this->columns = $dashletData['MyLatestCallsDashlet']['columns'];
