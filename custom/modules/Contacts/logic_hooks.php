...
$hook_array['after_relationship_add'][] = Array(1, 'Update Modified Date After relationship add', 'custom/modules/Contacts/contactsCustomCode.php', 'contactsCustomCode', 'updateDateModified');
?>