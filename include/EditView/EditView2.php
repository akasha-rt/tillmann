...
class EditView {
    ...
    function display($showTitle = true, $ajaxSave = false) {
        ...
        /**
         * To remove account from validation
         * @author Dhaval Darji
         */
        if ($form_name == 'form_EmailQCView_Cases')
            $str .= '<script type="text/javascript">
            removeFromValidate("form_EmailQCView_Cases","account_name");      
            removeFromValidate("form_EmailQCView_Cases","account_id");      
                </script>';
        return $str;
    }
