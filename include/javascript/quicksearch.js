...
if(QSProcessedFieldsArray[qs_index_id]){skipSTR='collection_0';if(qs_index_id.lastIndexOf(skipSTR)!=(qs_index_id.length-skipSTR.length)){if(qs_index_id!='form_EmailQCView_Cases_assigned_user_name')continue;}}
