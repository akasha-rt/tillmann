...
'</td><td style="padding: 0px !important;margin:0px; !important">&nbsp;&nbsp;{mod_strings.LBL_EMAIL_RELATE}:&nbsp;&nbsp;<select class="select" id="data_parent_type{idx}" onchange="document.getElementById(\'data_parent_name{idx}\').value=\'\';document.getElementById(\'data_parent_id{idx}\').value=\'\'; SUGAR.email2.composeLayout.enableQuickSearchRelate(\'{idx}\');SUGAR.email2.composeLayout.enableQuickSearchEmail(\'{idx}\');" name="data_parent_type{idx}">{linkbeans_options}</select>' + 
...
'							<td class="emailUIField" NOWRAP>' +
'								<div class="">' +
'									&nbsp;&nbsp;<input class="sqsEnabled" type="text" size="96" id="addressTO{idx}" title="{app_strings.LBL_EMAIL_TO}" name="addressTO{idx}" onkeyup="SE.composeLayout.showAddressDetails(this);">' +
