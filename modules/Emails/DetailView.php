...
$composeData = array("parent_id" => $_REQUEST['parent_id'], "parent_type" => $_REQUEST['parent_module'], "parent_name" => $focus->parent_name, "to_email_addrs" => $focus->to_addrs, "subject" => $focus->name, "body" => $description);
