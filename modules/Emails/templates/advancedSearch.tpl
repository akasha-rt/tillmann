...
<table cellpadding="4" cellspacing="0" border="0" id='advancedSearchTable'>
    ...
    {** Add the functionality to Search Email by word in Email BODY
        @author Dhaval Darji
    *}
    <tr>
		<td class="advancedSearchTD">
    ...
    *}
    ...
    <tr class="toggleClass yui-hidden">
        <td NOWRAP class="advancedSearchTD">
        {$mod_strings.LBL_LIST_STATUS}:<br/>
        {html_options options=$statusOptions name='status' id='searchStatus'}
        </td>
    </tr>
     <tr class="toggleClass yui-hidden">
