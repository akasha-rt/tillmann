...
class AuthenticationController {
    ...
    public function sessionAuthenticate() {
        ...
        if ($this->authenticated) {
            ...
            //To logout after inactivity of 30 min = 1800 sec
            //$_SESSION['userStats']['lastTime'] = time();
            //$_SESSION['userStats']['pages']++;
            //Skip if request is sent for notification as its generating req for each 10 sec
            if ($_REQUEST['module'] == 'Home' && $_REQUEST['action'] == 'getnotify') {
